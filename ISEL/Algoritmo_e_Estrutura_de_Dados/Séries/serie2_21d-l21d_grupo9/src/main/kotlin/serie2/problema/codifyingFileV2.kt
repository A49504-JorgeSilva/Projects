...
import serie2.mapCollections.HashMap
import serie2.mapCollections.toList

fun main(args: Array<String>){
    codifyingFileV2(args)
}

fun codifyingFileV2(args: Array<String>){
    ...
    while (i <= listOfKeys.size - 1 && j >= 0){
        codedMap[listOfKeys.get(j)] = listOfKeys[i]
        i++
        j--
    }
