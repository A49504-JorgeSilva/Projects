...
def compareSequence(initialSequence, finalSequence):
    different = 0
    for i in range(len(initialSequence)):
...
outFile = [
    r"E:\Documentos\Universidade\CD\CD42D-G11\Trab2\1\Alice Testing\Interleaving\Hamming\out1.txt",
    r"E:\Documentos\Universidade\CD\CD42D-G11\Trab2\1\Alice Testing\Interleaving\Hamming\out2.txt",
    r"E:\Documentos\Universidade\CD\CD42D-G11\Trab2\1\Alice Testing\Interleaving\Hamming\out3.txt",
    r"E:\Documentos\Universidade\CD\CD42D-G11\Trab2\1\Alice Testing\Interleaving\Hamming\out4.txt",
    r"E:\Documentos\Universidade\CD\CD42D-G11\Trab2\1\Alice Testing\Interleaving\Hamming\out5.txt"
]
